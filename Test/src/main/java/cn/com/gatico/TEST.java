...
public class TEST {
    private static final Integer port = 8080;//HTTP默认端口8080
    private static final String path="/home/tianci.gao/IdeaProjects/GaticoProject/Test/src/main/java/cn/com/gatico/wwwroot";
...
//通过HTTP请求中的uri读取相应文件发送给客户端
                    FileInputStream writehtml = new FileInputStream(new File(path + uri));
                    outSocket.write("\r\n".getBytes());
